...
namespace LINQtoCSV.Excel
{
    internal class FieldMapper<T> 
    {
        ...
        protected ExcelFileDescription m_fileDescription;
        ...
        public FieldMapper(ExcelFileDescription fileDescription, string fileName, bool writingFile)
        {
    ...
    internal class FieldMapper_Reading<T> : FieldMapper<T> where T : new()
    {
        ...
        public Dictionary<int, int> GetCharLengths()
        {

            return m_IndexToInfo.ToDictionary(x => x.index, x => x.charLength);
